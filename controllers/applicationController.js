...
exports.create = async (req, res) => {
  try {
    const { to_id, cover_letter, bid_price, resume, description, gig_id } =
      req.body;
  ...
  try {
    ...
    if (status == "completed") {
      ...
      const transaction = new Transaction({
        ...
        type: "deposit",
        description: `${req?.user?.lang=='english'?lang["invoicefor"]:lang2["invoicefor"]} (` + updatedSession.description + `)`,
      });
      ...
      const feeTransaction = new Transaction({
        ...
        type: "fee",
        description: `${req?.user?.lang=='english'?lang["servicefee"]:lang2["servicefee"]} (` + updatedSession.description + `)`,
      });
